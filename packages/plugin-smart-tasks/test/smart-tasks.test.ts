...
import type { TaskBackend, Task } from '@loopwork-ai/contracts'
...
describe('Smart Tasks Plugin', () => {
  ...
  describe('Plugin Creation', () => {
    ...
    test('creates conservative preset', () => {
      ...
      const config = wrapper({ plugins: [] } as any) as any
  ...
  describe('Recent Task Tracking', () => {
    test('maintains history of recent completed tasks', async () => {
      ...
      for (let i = 1; i <= 3; i++) {
        ...
        await plugin.onTaskComplete?.(context, { success: true } as any)
      }
