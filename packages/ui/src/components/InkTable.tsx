...
export interface InkColumnConfig {
  width?: number
 ...
 * InkTable Component
 *
 * Renders a table with Unicode box-drawing characters.
 * Supports custom column widths, alignment, and theme colors.
 */
export const InkTable: React.FC<InkTableProps> = ({
  ...
  const alignCell = (text: string, width: number, align: InkColumnConfig['align'] = 'left') => {
